...
namespace AssitADSOproyect.Controllers
{
    public class Programa_formacionController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id_programa,Nombre_programa,Tipo_programa,Duracion_programa,Estado_Programa_formacion")] Programa_formacion programa_formacion) 
        {
