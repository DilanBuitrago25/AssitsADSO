...
namespace AssitADSOproyect.Controllers
{
    public class UsuariosInstructorController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id_usuario,Documento_usuario,Tipo_Documento_usuario,Nombre_usuario,Apellido_usuario,Telefono_usuario,Correo_usuario,Contrasena_usuario,Tipo_instructor,Tipo_usuario,Id_ficha,Esinstructormaster_usuario")] Usuario usuario)
        {
            if (ModelState.IsValid)
            {
